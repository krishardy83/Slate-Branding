...
<xsl:stylesheet version="1.0" exclude-result-prefixes="xhtml" xmlns="http://www.w3.org/1999/xhtml" xmlns:fw="http://technolutions.com/framework" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:template match="/">
    ...
    <a
      href="#content"
      class="btn-tertiary fixed left-1/2 top-0 z-50 -translate-x-1/2 -translate-y-full focus:translate-y-0"
      >Skip to content</a
    >
    <div
      data-menu="data-menu"
      ...
      <header class="mx-auto max-w-6xl px-4">
        <nav class="flex flex-wrap items-end" data-analytics="navigation">
          <a
            ...
            class="invisible mr-auto mt-4 text-primary-800 transition-opacity group-data-[compress='true']:opacity-0 lg:invisible"
          >
            <svg
              version="1.1"
              ...
              x="0"
              y="0"
              viewBox="0 0 227 61.29"
              xml:space="preserve"
              width="220"
              height="60"
              role="img"
              class="max-w-40 lg:max-w-full"
            >
              <path
                fill="currentColor"
          ...
          <div class="slate-hidden grow flex-col justify-end transition-opacity lg:flex">
            ...
            >
              <li class="relative">
                <button
                  type="button"
                  id="group-button-info-for"
                  aria-controls="group-info-for"
                  aria-expanded="false"
                  aria-haspopup="true"
                  class="group flex items-center gap-x-2 px-4 py-3 text-xs uppercase text-primary-800 transition-colors hover:text-tertiary-400 aria-expanded:bg-primary-800 aria-expanded:text-white group-data-[scrolling='true']:aria-expanded:text-white xl:text-sm"
                >
                  Info For
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div
                  aria-labelledby="group-button-info-for"
                  aria-hidden="true"
                  id="group-info-for"
                ...
                >
                  <ul class="flex flex-col">
                    <li>
                      <a href="https://www.messiah.edu/future-students" class="link my-2 block">
                        Future Students
                      </a>
                    </li>
                    <li>
                      <a href="https://www.messiah.edu/current-students" class="link my-2 block">
                        Current Students
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="https://www.messiah.edu/faculty-staff" class="link my-2 block">
                        Faculty &amp; Staff
                      </a>
                    </li>
                    <li>
                      <a href="https://www.messiah.edu/admision" class="link my-2 block">
                        Español
                      </a>
                    </li>
                    <li role="separator" class="my-4 h-px w-full bg-primary-500"></li>
                    <li>
                      <a
                        href="https://www.messiah.edu/applytoday"
                        class="btn-quaternary mb-2 w-full"
                      >
                        Apply
                      </a>
                    </li>
                    <li>
                      <a href="https://www.messiah.edu/visit" class="btn-quaternary mb-2 w-full">
                        Visit
                      </a>
                    </li>
                    <li>
              ...
              <li class="relative">
                ...
                <div
                  aria-labelledby="group-button-quick-links"
                  aria-hidden="true"
                  id="group-quick-links"
                  class="slate-hidden absolute right-0 z-10 w-72 bg-primary-800 p-8 text-white opacity-0 transition-opacity duration-300 before:absolute before:bottom-0 before:left-0 before:h-2 before:w-full before:bg-gradient-to-r before:from-primary-600 before:to-secondary-600"
                  role="region"
                >
                  <ul class="flex flex-col">
                    <li>
                      <a href="https://www.messiah.edu/campus_directory" class="link my-2 block">
                        Campus Directory
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a
                        href="https://www.messiah.edu/homepage/3099/contact_us"
                        class="link my-2 block"
                      >
                        Contact Us
                      </a>
                    </li>
              ...
              <li>
                <a
                  href="/"
                  class="block px-4 py-3 text-xs uppercase text-primary-800 transition-colors hover:text-tertiary-400 xl:text-sm"
                >
                  Give
                </a>
              </li>
              <li>
                <button
                  ...
                  class="ml-4 mt-1 text-primary-800 transition-colors hover:text-tertiary-400"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    ...
                    stroke-width="1.5"
                    stroke="currentColor"
                    class="pointer-events-none size-4 xl:size-5"
                  >
                    <path
                      stroke-linecap="round"
                      stroke-linejoin="round"
            ...
            <ul class="flex items-center justify-end gap-4 lg:gap-6">
              <li>
                <button
                  type="button"
                  aria-expanded="false"
                  id="group-button-about"
                  aria-controls="group-about"
                  aria-haspopup="true"
                  class="group relative flex items-center gap-x-2 text-sm font-bold text-primary-800 transition-colors after:absolute after:left-0 after:right-0 after:top-10 after:h-3 after:bg-transparent after:transition-colors after:duration-300 hover:text-tertiary-400 aria-expanded:after:bg-gray-100 xl:text-lg"
                >
                  About
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div
                  ...
                  aria-labelledby="group-button-about"
                  aria-hidden="true"
                  role="region"
                >
                  <div class="mx-auto flex max-w-6xl gap-12 px-4">
                    ...
                    <ul class="flex-1 space-y-1 text-sm">
                      <li><a href="https://www.messiah.edu/about" class="link"> Overview </a></li>
                      <li>
                        <a href="https://www.messiah.edu/info/20000/about#overview" class="link">
                          Who we are
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/info/20000/about#campus" class="link">
                          Our campus
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/info/20000/about#faith" class="link">
                          Faith community
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/info/20000/about#anew" class="link">
                          See anew
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/info/20000/about#history" class="link">
                          Our history
                        </a>
                      </li>
                    </ul>
                    <ul class="flex-1 space-y-1 text-sm">
                      <li>
                        <a href="https://www.messiah.edu/info/20020/recognitions" class="link">
                          Recognitions
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/info/20002/college_profile" class="link">
                          At a glance
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/info/20015/news_and_events" class="link">
                          News and events
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/info/20012/accreditation" class="link">
                          Accreditation
                        </a>
                      </li>
                      <li>
                        <a
                          href="https://www.messiah.edu/info/20016/college_leadership"
                          class="link"
                        >
                      ...
                      <li>
                        <a
                          href="https://www.messiah.edu/info/20000/about/1990/student_consumer_info"
                          class="link"
                        >
              ...
              <li>
                <button
                  type="button"
                  aria-expanded="false"
                  id="group-button-academics"
                  aria-controls="group-academics"
                  aria-haspopup="true"
                  class="group relative flex items-center gap-x-2 text-sm font-bold text-primary-800 transition-colors after:absolute after:left-0 after:right-0 after:top-10 after:h-3 after:bg-transparent after:transition-colors after:duration-300 hover:text-tertiary-400 aria-expanded:after:bg-gray-100 xl:text-lg"
                >
                  Academics
                ...
                <div
                  id="group-academics"
                  class="slate-hidden absolute left-0 z-30 mt-6 w-full bg-gray-100 py-12 opacity-0 transition-opacity duration-300"
                  aria-labelledby="group-button-academics"
                  aria-hidden="true"
                  role="region"
                >
                  <div class="mx-auto flex max-w-6xl gap-12 px-4">
                    <div class="w-2/5 border-r border-gray-300 pr-12">
                      <p class="mb-4 text-2xl font-bold text-primary-800">
                        Messiah University is nationally recognized for its integration of top-tier
                    ...
                    <ul class="flex-1 space-y-1 text-sm">
                      <li>
                        <a
                          href="https://www.messiah.edu/academics?type=ug"
                          class="link font-title text-xl font-bold uppercase text-primary-800"
                        >
                          Undergraduate
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/majors-minors-programs" class="link">
                          Majors and minors
                        </a>
                      </li>
                      <li>
                        <a
                          href="https://www.messiah.edu/academics?type=ug#accelerated-options"
                          class="link"
                        >
                          Accelerated options
                        </a>
                      ...
                      <li>
                        <a
                          href="https://www.messiah.edu/academics?type=ug#academic-support"
                          class="link"
                        >
                          Academic support
                        </a>
                      ...
                      <li>
                        <a href="https://www.messiah.edu/career-outcomes" class="link">
                          Careers and outcomes
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/study-abroad" class="link">
                          Study abroad
                        </a>
                      </li>
                    </ul>
                    <ul class="flex-1 space-y-1 text-sm">
                      <li>
                        <a
                          href="https://www.messiah.edu/academics?type=grad"
                          class="link font-title text-xl font-bold uppercase text-primary-800"
                        >
                          Graduate
                        </a>
                      ...
                      <li>
                        <a
                          href="https://www.messiah.edu/academics?type=grad#our-programs"
                          class="link"
                        >
                      ...
                      <li>
                        <a
                          href="https://www.messiah.edu/academics?type=grad#why-messiah"
                          class="link"
                        >
                      ...
                      <li>
                        <a href="https://www.messiah.edu/grad-careers" class="link">
                          Career development
                        </a>
                      </li>
                    </ul>
                    <ul class="flex-1 space-y-1 text-sm">
                      ...
                      <li>
                        <a href="https://www.messiah.edu/info/21164/library" class="link">
                          Library
                        </a>
                      </li>
                      <li>
                        <a
                          href="https://www.messiah.edu/info/23055/career_and_professional_development_center"
                          class="link"
                        >
                      ...
                      <li>
                        <a
                          href="https://www.messiah.edu/info/20029/schools_and_departments"
                          class="link"
                        >
                      ...
                      <li>
                        <a
                          href="https://www.messiah.edu/info/20098/college_honors_program"
                          class="link"
                        >
              ...
              <li>
                <button
                  type="button"
                  aria-expanded="false"
                  id="group-button-admissions"
                  aria-controls="group-admissions"
                  aria-haspopup="true"
                  class="group relative flex items-center gap-x-2 text-sm font-bold text-primary-800 transition-colors after:absolute after:left-0 after:right-0 after:top-10 after:h-3 after:bg-transparent after:transition-colors after:duration-300 hover:text-tertiary-400 aria-expanded:after:bg-gray-100 xl:text-lg"
                >
                  Admissions
                ...
                <div
                  id="group-admissions"
                  class="slate-hidden absolute left-0 z-30 mt-6 w-full bg-gray-100 py-12 opacity-0 transition-opacity duration-300"
                  aria-labelledby="group-button-admissions"
                  aria-hidden="true"
                  role="region"
                >
                  <div class="mx-auto flex max-w-6xl gap-12 px-4">
                    <div class="w-2/5 border-r border-gray-300 pr-12">
                      <p class="mb-4 text-2xl font-bold text-primary-800">
                        We educate strong servant leaders who combine professional expertise with a
                        reconciling spirit.
                      </p>
                    </div>
                    <ul class="flex-1 space-y-1 text-sm">
                      <li>
                        <a
                          href="https://www.messiah.edu/info/21083/undergraduate_admissions"
                          class="link font-title text-xl font-bold uppercase text-primary-800"
                        >
                          Undergraduate
                        </a>
                      </li>
                      <li><a href="https://www.messiah.edu/applytoday" class="link"> Apply </a></li>
                      <li>
                        <a href="https://www.messiah.edu/request-info" class="link">
                          Request information
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/info/21344/tuition_and_aid" class="link">
                          Cost of tuition
                        </a>
                      </li>
                      <li>
                      ...
                      <li>
                        <a
                          href="https://www.messiah.edu/info/21356/meet_your_counselor"
                          class="link"
                        >
                          Meet your counselor
                        </a>
                      ...
                      <li><a href="https://www.messiah.edu/admision" class="link"> Español </a></li>
                    </ul>
                    <ul class="flex-1 space-y-1 text-sm">
                      <li>
                        <a
                          href="https://www.messiah.edu/info/21084/graduate_admissions"
                          class="link font-title text-xl font-bold uppercase text-primary-800"
                        >
                          Graduate
                        </a>
                      ...
                      <li>
                        <a href="https://www.messiah.edu/grad-rfi" class="link">
                          Request information
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/info/22863/cost_and_aid" class="link">
                          Tuition and aid
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/grad-accepted" class="link">
                          Accepted students
                        </a>
                      </li>
                    </ul>
                    <ul class="flex-1 space-y-1 text-sm">
                      ...
                      <li>
                        <a href="https://www.messiah.edu/visit#event-types" class="link">
                          Browse by event type
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/visit#calendar" class="link">
                      ...
                      <li>
                        <a
                          href="https://www.messiah.edu/info/21343/visit_campus/13/directions"
                          class="link"
                        >
                          Directions
                        </a>
              ...
              <li>
                <button
                  type="button"
                  aria-expanded="false"
                  id="group-button-athletics"
                  aria-controls="group-athletics"
                  aria-haspopup="true"
                  class="group relative flex items-center gap-x-2 text-sm font-bold text-primary-800 transition-colors after:absolute after:left-0 after:right-0 after:top-10 after:h-3 after:bg-transparent after:transition-colors after:duration-300 hover:text-tertiary-400 aria-expanded:after:bg-gray-100 xl:text-lg"
                >
                  Athletics
                ...
                <div
                  id="group-athletics"
                  class="slate-hidden absolute left-0 z-30 mt-6 w-full bg-gray-100 py-12 opacity-0 transition-opacity duration-300"
                  aria-labelledby="group-button-athletics"
                  aria-hidden="true"
                  role="region"
                >
                  <div class="mx-auto flex max-w-6xl gap-12 px-4">
                    <div class="w-2/5 border-r border-gray-300 pr-12">
                      <p class="mb-4 text-2xl font-bold text-primary-800">
                        Athletics serve as an exciting piece of our community and provide a common
                        bond for school spirit.
                      </p>
                      <a
                    ...
                    <ul class="flex-1 space-y-1 text-sm">
                      ...
                      <li>
                        <a href="https://gomessiah.com/calendar.aspx" class="link">
                          Full calendar
                        </a>
                      </li>
                      <li><a href="http://gomessiah.com/tv" class="link"> GoMessiah.tv </a></li>
                      <li>
                        <a
                          href="http://gomessiah.com/sports/2014/8/5/GEN_0805140853.aspx"
                          class="link"
                        >
                          Be recruited
                        </a>
                      ...
                      <li>
                        <a
                          href="https://gomessiah.com/sports/2023/2/8/messiah-athletics-camps.aspx"
                          class="link"
                        >
                          Sports camps
                        </a>
                    ...
                    <ul class="flex-1 space-y-1 text-sm">
                      ...
                      <li>
                        <a
                          href="https://www.messiah.edu/athletics-and-recreation#sports"
                          class="link"
                        >
                          Club &amp; rec sports
                        </a>
                      ...
                      <li>
                        <a
                          href="https://www.messiah.edu/athletics-and-recreation#fitness"
                          class="link"
                        >
                          Physical fitness
                        </a>
                      ...
                      <li>
                        <a
                          href="https://www.messiah.edu/athletics-and-recreation#game-day"
                          class="link"
                        >
                          Game day
                        </a>
                      ...
                      <li>
                        <a
                          href="https://www.messiah.edu/athletics-and-recreation#sports-ministry"
                          class="link"
                        >
                          Sports ministry
                        </a>
              ...
              <li>
                <button
                  type="button"
                  aria-expanded="false"
                  id="group-button-faith-service"
                  aria-controls="group-faith-service"
                  aria-haspopup="true"
                  class="group relative flex items-center gap-x-2 text-sm font-bold text-primary-800 transition-colors after:absolute after:left-0 after:right-0 after:top-10 after:h-3 after:bg-transparent after:transition-colors after:duration-300 hover:text-tertiary-400 aria-expanded:after:bg-gray-100 xl:text-lg"
                >
                  Faith &amp; Service
                ...
                <div
                  id="group-faith-service"
                  class="slate-hidden absolute left-0 z-30 mt-6 w-full bg-gray-100 py-12 opacity-0 transition-opacity duration-300"
                  aria-labelledby="group-button-faith-service"
                  aria-hidden="true"
                  role="region"
                >
                  <div class="mx-auto flex max-w-6xl gap-12 px-4">
                    <div class="w-2/5 border-r border-gray-300 pr-12">
                      <p class="mb-4 text-2xl font-bold text-primary-800">
                        Our motto, &#39;Christ Preeminent&#39;, shapes every experience you&#39;ll
                        have as a student at Messiah.
                      </p>
                      <a href="https://www.messiah.edu/faithandservice" class="btn-secondary">
                        Start here
                      </a>
                    </div>
                    <ul class="flex-1 space-y-1 text-sm">
                      <li>
                        <a href="https://www.messiah.edu/faithandservice" class="link">
                          Overview
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/faithandservice#grow" class="link">
                          Grow your faith
                        </a>
                      </li>
                      <li>
                    ...
                    <ul class="flex-1 space-y-1 text-sm">
                      <li>
                        <a href="https://www.messiah.edu/faithandservice#church" class="link">
                          Find a church
                        </a>
                      </li>
                      <li>
              ...
              <li>
                <button
                  type="button"
                  aria-expanded="false"
                  id="group-button-student-life"
                  aria-controls="group-student-life"
                  aria-haspopup="true"
                  class="group relative flex items-center gap-x-2 text-sm font-bold text-primary-800 transition-colors after:absolute after:left-0 after:right-0 after:top-10 after:h-3 after:bg-transparent after:transition-colors after:duration-300 hover:text-tertiary-400 aria-expanded:after:bg-gray-100 xl:text-lg"
                >
                  Student Life
                ...
                <div
                  id="group-student-life"
                  class="slate-hidden absolute left-0 z-30 mt-6 w-full bg-gray-100 py-12 opacity-0 transition-opacity duration-300"
                  aria-labelledby="group-button-student-life"
                  aria-hidden="true"
                  role="region"
                >
                  <div class="mx-auto flex max-w-6xl gap-12 px-4">
                    <div class="w-2/5 border-r border-gray-300 pr-12">
                      <p class="mb-4 text-2xl font-bold text-primary-800">
                        Messiah’s campus is an active, busy place where you’ll have fun and make
                        lifelong friendships.
                      </p>
                      <a href="https://www.messiah.edu/studentlife" class="btn-secondary">
                        Start here
                      </a>
                    </div>
                    <ul class="flex-1 space-y-1 text-sm">
                      ...
                      <li>
                        <a href="https://www.messiah.edu/student-life#student-life" class="link">
                          Life on campus
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/student-life#to-do" class="link">
                          Things to do
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/student-life#home" class="link">
                          Your new home
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/student-life#res-life" class="link">
                          Living on campus
                        </a>
                      </li>
                    </ul>
                    <ul class="flex-1 space-y-1 text-sm">
                      <li>
                        <a href="https://www.messiah.edu/student-life#faq" class="link">
                          Frequently asked questions
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/student-life#dining" class="link">
                          Dining facilities
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/student-life#diversity" class="link">
                          A diverse community
                        </a>
                      </li>
                      <li>
                        <a href="https://www.messiah.edu/student-life#support" class="link">
                          Student support
                        </a>
                      </li>
                    </ul>
    ...
    <button
      ...
      data-mobile-menu-trigger="data-mobile-menu-trigger"
      aria-expanded="false"
    ...
    <a
      href="/"
      aria-label="home page"
      class="lg:slate-hidden relative z-10 ml-4 mt-2 block text-primary-800 transition-opacity"
    >
      <svg
        version="1.1"
        xmlns="http://www.w3.org/2000/svg"
    ...
    <div
      ...
      data-mobile-menu-content="data-mobile-menu-content"
    >
      <svg
        version="1.1"
        xmlns="http://www.w3.org/2000/svg"
        ...
        <ul>
          <li>
            <button
              ...
              aria-expanded="false"
              aria-haspopup="true"
              data-mobile-group-trigger="data-mobile-group-trigger"
              id="mobile-group-button-about"
              aria-controls="mobile-group-about"
            ...
            >
              About
              <span
                class="pointer-events-none relative block size-6 rounded-full bg-white transition-transform duration-300 before:absolute before:left-1/2 before:top-1.5 before:h-3 before:w-0.5 before:-translate-x-1/2 before:bg-primary-800 after:absolute after:left-1.5 after:top-1/2 after:h-0.5 after:w-3 after:-translate-y-1/2 after:bg-primary-800 after:transition-all after:duration-300 group-aria-expanded:rotate-90 group-aria-expanded:after:w-0"
              ></span>
            </button>
            <div
              id="mobile-group-about"
              class="mt-4 h-[--height] overflow-hidden transition-all duration-300"
              role="region"
              aria-labelledby="mobile-group-button-about"
              hidden="hidden"
            >
          ...
          <li>
            <button
              ...
              aria-haspopup="true"
               data-mobile-group-trigger="data-mobile-group-trigger"
              id="mobile-group-button-academics"
              aria-controls="mobile-group-academics"
              class="group flex w-full items-center justify-between gap-x-2 border-b border-white/50 py-4 text-xl font-bold transition-colors hover:text-tertiary-400"
            >
              Academics
              <span
            ...
            <div
              id="mobile-group-academics"
              class="mt-4 h-[--height] overflow-hidden transition-all duration-300"
              role="region"
              aria-labelledby="mobile-group-button-academics"
              hidden="hidden"
            >
              <ul class="mb-2 ml-4 flex flex-col gap-2">
                <li>
                  <a
                    href="https://www.messiah.edu/academics?type=ug"
                    class="link mt-4 block font-title text-xl font-bold uppercase"
                  >
                    Undergraduate
                  </a>
                </li>
              ...
              <ul class="mb-2 ml-4 flex flex-col gap-2">
                <li>
                  <a href="/" class="link mt-4 block font-title text-xl font-bold uppercase">
                    Quicklinks
                  </a>
                </li>
                <li>
          ...
          <li>
            <button
              ...
              aria-haspopup="true"
               data-mobile-group-trigger="data-mobile-group-trigger"
              id="mobile-group-button-admissions"
              aria-controls="mobile-group-admissions"
              class="group flex w-full items-center justify-between gap-x-2 border-b border-white/50 py-4 text-xl font-bold transition-colors hover:text-tertiary-400"
            >
              Admissions
              <span
            ...
            <div
              id="mobile-group-admissions"
              class="mt-4 h-[--height] overflow-hidden transition-all duration-300"
              role="region"
              aria-labelledby="mobile-group-button-admissions"
              hidden="hidden"
            >
              <ul class="mb-2 ml-4 flex flex-col gap-2">
                <li>
              ...
              <ul class="mb-2 ml-4 flex flex-col gap-2">
                ...
                <li><a href="https://www.messiah.edu/info/21329/apply" class="link"> Apply </a></li>
                <li>
              ...
              <ul class="mb-2 ml-4 flex flex-col gap-2">
                ...
                <li><a href="https://tour.messiah.edu/" class="link"> View virtual tour </a></li>
                <li>
                  <a
                    href="https://www.messiah.edu/info/21343/visit_campus/13/directions"
                    class="link"
                ...
                <li><a href="https://tour.messiah.edu/campus-map" class="link"> Campus Map </a></li>
              </ul>
            </div>
          </li>
          <li>
            <button
              ...
              aria-haspopup="true"
               data-mobile-group-trigger="data-mobile-group-trigger"
              id="mobile-group-button-athletics"
              aria-controls="mobile-group-athletics"
              class="group flex w-full items-center justify-between gap-x-2 border-b border-white/50 py-4 text-xl font-bold transition-colors hover:text-tertiary-400"
            >
              Athletics
              <span
            ...
            <div
              id="mobile-group-athletics"
              class="mt-4 h-[--height] overflow-hidden transition-all duration-300"
              role="region"
              aria-labelledby="mobile-group-button-athletics"
              hidden="hidden"
            >
              <ul class="mb-2 ml-4 flex flex-col gap-2">
                <li>
              ...
              <ul class="mb-2 ml-4 flex flex-col gap-2">
                ...
                <li>
                  <a href="https://www.messiah.edu/athletics-and-recreation#game-day" class="link">
                    Game day
                  </a>
                </li>
                <li>
          ...
          <li>
            <button
              ...
              aria-haspopup="true"
              data-mobile-group-trigger="data-mobile-group-trigger"
              id="mobile-group-button-faith-service"
              aria-controls="mobile-group-faith-service"
              class="group flex w-full items-center justify-between gap-x-2 border-b border-white/50 py-4 text-xl font-bold transition-colors hover:text-tertiary-400"
            >
              Faith &amp; Service
              <span
            ...
            <div
              id="mobile-group-faith-service"
              class="mt-4 h-[--height] overflow-hidden transition-all duration-300"
              role="region"
              aria-labelledby="mobile-group-button-faith-service"
              hidden="hidden"
            >
              <ul class="mb-2 ml-4 flex flex-col gap-2">
                <li>
          ...
          <li>
            <button
              ...
              aria-haspopup="true"
               data-mobile-group-trigger="data-mobile-group-trigger"
              id="mobile-group-button-student-life"
              aria-controls="mobile-group-student-life"
              class="group flex w-full items-center justify-between gap-x-2 border-b border-white/50 py-4 text-xl font-bold transition-colors hover:text-tertiary-400"
            >
              Student Life
              <span
            ...
            <div
              id="mobile-group-student-life"
              class="mt-4 h-[--height] overflow-hidden transition-all duration-300"
              role="region"
              aria-labelledby="mobile-group-button-student-life"
              hidden="hidden"
            >
              <ul class="mb-2 ml-4 flex flex-col gap-2">
                <li><a href="https://www.messiah.edu/studentlife" class="link"> Overview </a></li>
                <li>
                  <a href="https://www.messiah.edu/student-life#student-life" class="link">
                    Life on campus
                  </a>
        ...
        <ul class="mt-4 flex flex-col gap-4 sm:flex-row">
          <li class="border border-tertiary-300 p-4 sm:w-1/2">
            ...
            <ul class="mb-2 flex flex-col gap-2">
              ...
              <li>
                <a href="https://www.messiah.edu/current-students" class="link">
                  Current Students
                </a>
              </li>
              <li>
                <a href="https://www.messiah.edu/visitors-neighbors" class="link">
                  Visitors &amp; Neighbors
                </a>
              </li>
              <li>
                <a href="https://www.messiah.edu/alumni-parents" class="link">
                  Alumni &amp; Parents
                </a>
              </li>
              <li>
                <a href="https://www.messiah.edu/faculty-staff" class="link">
                  Faculty &amp; Staff
                </a>
              </li>
              <li><a href="https://www.messiah.edu/admision" class="link"> Español </a></li>
              <li><a href="https://www.messiah.edu/applytoday" class="link"> Apply </a></li>
              <li><a href="https://www.messiah.edu/visit" class="link"> Visit </a></li>
              <li>
                <a href="https://www.messiah.edu/homepage/1553/request_information" class="link">
                  Request Info
                </a>
              </li>
            </ul>
          ...
          <li class="border border-tertiary-300 p-4 sm:w-1/2">
            ...
            <ul class="mb-2 flex flex-col gap-2">
              <li>
                <a href="https://www.messiah.edu/campus_directory" class="link">
                  Campus Directory
                </a>
              </li>
              <li><a href="https://www.messiah.edu/news" class="link"> News </a></li>
              <li><a href="https://www.messiah.edu/events" class="link"> Events </a></li>
              <li>
                <a href="https://www.messiah.edu/homepage/3099/contact_us" class="link">
                  Contact Us
                </a>
              </li>
              <li><a href="https://www.messiah.edu/applytoday" class="link"> Apply </a></li>
      ...
      <ul class="mt-4 grid grid-cols-2 gap-4">
        <li>
          <a href="https://www.messiah.edu/applytoday" class="btn-quaternary h-full w-full"
            >Apply</a
          >
        </li>
        <li>
